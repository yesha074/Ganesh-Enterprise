            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl mt-3 mx-xl-3 p-xl-0 px-md-5">
                        <div class="header">
                            <div class="text">
                                <img src="<?php echo base_url(); ?>admin/images/profile.jpg" class="img-fluid rounded-circle" alt="Responsive image">
                                <h2>Matthew Scott</h2>
    ...
    <!-- loading-gif Js -->
    <script src="<?php echo base_url(); ?>admin/js/modernizr.js"></script>
    <script>
    ...
    <!-- Graph -->
    <script src="<?php echo base_url(); ?>admin/js/SimpleChart.js"></script>
    <script>
        var graphdata4 = {
            linecolor: "Random",
            title: "Thursday",
    ...
    <!--// Graph -->
    <!-- Bar-chart -->
    <script src="<?php echo base_url(); ?>admin/js/rumcaJS.js"></script>
    <script src="<?php echo base_url(); ?>admin/js/example.js"></script>
    <!--// Bar-chart -->
    <!-- Calender -->
    <script src="<?php echo base_url(); ?>admin/js/moment.min.js"></script>
    <script src="<?php echo base_url(); ?>admin/js/pignose.calender.js"></script>
    <script>
        //<![CDATA[
        $(function () {
    ...
    <!-- Count-down -->
    <script src="<?php echo base_url(); ?>admin/js/simplyCountdown.js"></script>
    <link href="<?php echo base_url(); ?>admin/css/simplyCountdown.css" rel='stylesheet' type='text/css' />
    <script>
        var d = new Date();
    ...
    <!-- pie-chart -->
    <script src='<?php echo base_url(); ?>admin/js/amcharts.js'></script>
    <script>
        var chart;
        var legend;
