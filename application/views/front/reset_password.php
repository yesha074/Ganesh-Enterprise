              ...
              $error_msg= $this->session->flashdata('error_msg');
                  ...
                  ?>
                                    <div class="login-Register-info">
                                        <form method="POST" action="<?php echo base_url('project/reset_pass'); ?>"> 
                                            <p class="coupon-input form-row-first">
                                                <label>New Password <span class="required">*</span></label>
                                                <input type="text" name="password" required="">
                                            </p>

                                                <input type="hidden" name="uid" value="<?php echo $id=$this->uri->segment('3'); ?>">
                                            <p class="coupon-input form-row-first">
                                           ...
                                           <div class="clear"></div>
                                            <p>
                                                <button value="Login" name="login" class="button-login" type="submit">Reset Password</button>
